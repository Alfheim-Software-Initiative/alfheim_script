...
su archlive -c "yaourt -Sy --noconfirm auto-auto-complete compiz-manager texman i3lock-fancy-git netcfg google-chrome-dev gksu ambiance-radiance-colors-suite atom-editor-bin zpaq obmenu-generator obmenu unetbootin gitg-git rust-nightly-bin"
