...
su archlive -c "yaourt -Sy base-devel auto-auto-complete texman netcfg-git google-chrome-dev yaourt-gui kodi-platform atom-editor-bin gitg-git zpaq obmenu-generator"
