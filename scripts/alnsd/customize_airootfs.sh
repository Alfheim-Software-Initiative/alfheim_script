...
su archlive -c "yaourt -Sy --noconfirm octopi octopi-cachecleaner octopi-repoeditor auto-auto-complete texman linphone i3lock-fancy-git netcfg google-chrome-dev yaourt-gui ambiance-radiance-colors-suite atom-editor-bin zpaq obmenu-generator obmenu unetbootin gitg-git rust-always-nightly-bin"
